...
case WHEN 	ROUND ((x.ipddischarge / IPDDEATH.IPDDISCHARGE) / 100,2) < 10 then 'text-success' else ' text-danger '  end as textcolor,
case WHEN  ROUND ((x.ipddischarge / IPDDEATH.IPDDISCHARGE) / 100,2) < 10 then 'border-success' else 'border-danger '  end as bordercolor,
