...
case WHEN 	ROUND ((x.ipddischarge / IPDDEATH.IPDDISCHARGE) / 100,2) < 5 then 'text-success' else ' text-danger '  end as textcolor,
case WHEN  ROUND ((x.ipddischarge / IPDDEATH.IPDDISCHARGE) / 100,2) < 5 then 'border-success' else 'border-danger '  end as bordercolor,
