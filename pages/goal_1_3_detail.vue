        ...
        <div class="card card-color">
          <div class="card-body">
            <h5 class="card-title font-color">
              ...
              กราฟแสดงอัตราตายทารกแรกเกิดตามปีงบประมาณ 5 ปีย้อนหลัง
            </h5>
      ...
      <div class="col-lg-6 p-3">
        <div class="card card-color">
          <div class="card-body">
            <h5 class="card-title font-color">
              <fa icon="chart-bar" class="fa-1x" />
              กราฟแสดงอัตราตายทารกแรกเกิดแยกรายเดือน {{ years[0] }}
            </h5>
...
export default {
  ...
  methods: {
    ...
    async fetch_line_year_chart() {
      ...
      await axios
        .get(`${this.$axios.defaults.baseURL}chartjs/goal1_3_year_chart.php`)
        .then((response) => {
    ...
    async fetch_bar_month_chart() {
      ...
      await axios
        .get(`${this.$axios.defaults.baseURL}chartjs/goal1_3_month_chart.php`)
        .then((response) => {
