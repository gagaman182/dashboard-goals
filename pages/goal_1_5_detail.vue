  ...
  <div class="container-fluid">
    <div class="row p-3">
      <div class="toolbargb col-lg-6 text-white card-body">
        <h6 class="h4 d-inline-block mb-0">
          อัตราการเสียชีวิตผู้ป่วย SEPSIS ทุกแบบ
        </h6>
        <p class="card-category">G10500</p>
      </div>
      <div class="toolbargb text-white col-lg-6 text-right">
        <fa icon="viruses" :class="textcolor" class="fa-4x" />
      </div>
    </div>
        ...
        <div class="card">
          <div class="card-body">
            <h5 class="card-title text-muted">
              ...
              ตารางแสดงอัตราการเสียชีวิตผู้ป่วย SEPSIS ทุกแบบแยกตามหอผู้ป่วย
              ปีงบ
              {{ years[0] }}
            </h5>
        ...
        <div class="card">
          <div class="card-body">
            <h5 class="card-title text-muted">
              ...
              กราฟแสดงอัตราการเสียชีวิตผู้ป่วย SEPSIS ทุกแบบแยกตามหอผู้ป่วย ปีงบ
              {{ years[0] }}
            </h5>
...
export default {
  ...
  methods: {
    ...
    async fetch_dead_table() {
      await axios
        .get(`${this.$axios.defaults.baseURL}goal1_5_detail.php`)
        .then((response) => {
    ...
    async fetch_dead_chart() {
      await axios
        .get(`${this.$axios.defaults.baseURL}chartjs/goal1_5_detail_chart.php`)
        .then((response) => {
