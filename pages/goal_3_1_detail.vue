  ...
  <div class="container-fluid">
    <div class="row p-3">
      <div class="toolbargb col-lg-6 texthead card-body">
        <h6 class="h4 d-inline-block mb-0">วันนอนเฉลี่ยผู้ป่วยในโรงพยาบาล</h6>
        <p class="card-category">G31100</p>
      </div>
        ...
        <div class="card card-color">
          <div class="card-body">
            <h5 class="card-title font-color">
              ...
              กราฟแสดงอัตราวันนอนเฉลี่ยผู้ป่วยในโรงพยาบาลตามปีงบประมาณ 5
              ปีย้อนหลัง
            </h5>
      ...
      <div class="col-lg-6 p-3">
        <div class="card card-color">
          <div class="card-body">
            <h5 class="card-title font-color">
              <fa icon="chart-bar" class="fa-1x" />
              กราฟแสดงอัตราวันนอนเฉลี่ยผู้ป่วยในโรงพยาบาลแยกรายเดือน
              {{ years[0] }}
            </h5>
      ...
      <div class="col-lg-12 p-3">
        <div class="card card-color">
          <div class="card-body">
            <h5 class="card-title font-color">
              <fa icon="chart-bar" class="fa-1x" />
              กราฟแสดงอัตราวันนอนเฉลี่ยผู้ป่วยในโรงพยาบาลแยกตามหอผู้ป่วย ปีงบ
              {{ years[0] }}
            </h5>
        ...
        <div class="card card-color">
          <div class="card-body">
            <h5 class="card-title font-color">
              ...
              ตารางแสดงอัตราวันนอนเฉลี่ยผู้ป่วยในโรงพยาบาลแยกตามหอผู้ป่วย ปีงบ
              {{ years[0] }}
            </h5>
...
export default {
  ...
  methods: {
    ...
    async fetch_dead_table() {
      await axios
        .get(`${this.$axios.defaults.baseURL}goal3_1_detail.php`)
        .then((response) => {
    ...
    async fetch_dead_chart() {
      ...
      await axios
        .get(`${this.$axios.defaults.baseURL}chartjs/goal3_1_detail_chart.php`)
        .then((response) => {
    ...
    async fetch_line_year_chart() {
      ...
      await axios
        .get(`${this.$axios.defaults.baseURL}chartjs/goal3_1_year_chart.php`)
        .then((response) => {
    ...
    async fetch_bar_month_chart() {
      ...
      await axios
        .get(`${this.$axios.defaults.baseURL}chartjs/goal3_1_month_chart.php`)
        .then((response) => {
